...
ActiveRecord::Schema.define(version: 2020_01_02_103403) do
  ...
  create_table "badges", force: :cascade do |t|
    ...
    t.bigint "rule_id"
    t.index ["picture_id"], name: "index_badges_on_picture_id"
  ...
  create_table "test_passages", force: :cascade do |t|
    ...
    t.integer "timedown", default: 0, null: false
  ...
  create_table "tests", force: :cascade do |t|
    ...
    t.integer "author_id"
    t.integer "timeset", default: 0, null: false
  ...
  add_foreign_key "badges", "pictures"
